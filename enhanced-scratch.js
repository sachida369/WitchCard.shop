...
class EnhancedScratchCard {
    ...
    addScratchEventListeners() {
        ...
        // Touch events
        this.canvas.addEventListener('touchstart', (e) => this.startScratchTouch(e));
        this.canvas.addEventListener('touchmove', (e) => this.scratchTouch(e));
        this.canvas.addEventListener('touchend', () => this.stopScratch());
        this.canvas.addEventListener('touchcancel', () => this.stopScratch());
